...
replace (
	github.com/pingcap/kvproto => github.com/you06/kvproto v0.0.0-20220921015855-823ee1a03c63
	github.com/tikv/client-go/v2 => github.com/you06/client-go/v2 v2.0.0-alpha.0.20220921150921-901e650103fc
)
