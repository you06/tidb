...
func getFeatureUsage(ctx context.Context, sctx sessionctx.Context) (*featureUsage, error) {
	...
	var err error
	usage.ClusterIndex, err = getClusterIndexUsageInfo(ctx, sctx)
	if err != nil {
...
func getClusterIndexUsageInfo(ctx context.Context, sctx sessionctx.Context) (cu *ClusterIndexUsage, err error) {
	...
	infoSchema := sctx.GetSessionVars().TxnCtx.InfoSchema.(infoschema.InfoSchema)
